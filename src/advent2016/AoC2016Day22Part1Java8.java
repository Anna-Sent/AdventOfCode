...
public class AoC2016Day22Part1Java8 {
    ...
    private static Node[][] read(String input) {
        ...
        for (String token : tokens) {
            ...
            if (m.matches()) {
                ...
                Node node = new Node(size, used, avail, use_percent);
                if (nodes[x][y] != null) {
    ...
    private static int countViablePairs(Node[][] nodes) {
        int count = 0;
        ...
        for (int i = 0; i < size; ++i) {
            ...
            count += list.stream().filter(nodeB -> nodeB != nodeA && isViable(nodeA, nodeB)).count();
        }
