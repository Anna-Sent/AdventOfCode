...
private fun test(input: String): Int {
    ...
    val monkeys = arrayListOf<Monkey1>()
    ...
    for (part in parts) {
        ...
        Monkey1(items.toMutableList(), operation, divisor, onTrue, onFalse).also { monkeys += it }
    }
...
private class Monkey1(val items: MutableList<Long>, val operation: String, val divisor: Int, val onTrue: Int, val onFalse: Int) {
    var times = 0
}
