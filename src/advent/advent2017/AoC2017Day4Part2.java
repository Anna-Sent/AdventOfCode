...
public class AoC2017Day4Part2 {
    public static void main(String[] args) {
        int result;

        result = test("abcde fghij\n" +
                "abcde xyz ecdab\n" +
        ...
        result = test("nyot babgr babgr kqtu kqtu kzshonp ylyk psqk\n" +
        ...
        assert result == 119 : "unexpected result is " + result;
        System.out.println(result);
    }
