...
public class AoC2018Day24Part1 {
    public static void main(String[] args) {
        ...
        assert result == 5216 : "unexpected result is " + result;
        ...
        assert result == 29865 : "unexpected result is " + result;
        System.out.println(result);
    }
    ...
    private static int test(String immuneSystemString, String infectionSystemString) {
        ...
        parse(infectionSystem, infectionSystemString, Type.infection);
    ...
    private static void parse(List<Group> groups, String s, Type type) {
        ...
        for (String token : tokens) {
            ...
            group.damage = Integer.parseInt(matcher.group(4));
