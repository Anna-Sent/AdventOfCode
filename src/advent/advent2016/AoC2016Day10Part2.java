...
public class AoC2016Day10Part2 {
    public static void main(String[] args) {
        int result;

        result = test("value 5 goes to bot 2" + "\r\n"
    ...
    private static int test(String s) {
        ...
        return outputs.get(0).value * outputs.get(1).value
                * outputs.get(2).value;
    }
