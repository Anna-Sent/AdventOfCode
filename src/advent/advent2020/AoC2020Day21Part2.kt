...
private fun test(input: String): String {
    ...
    val allergenToIngredients = TreeMap<String, MutableSet<String>>()
    ...
    return allergenToIngredients.values.map { it.toList()[0] }.joinToString(separator = ",")
}
...
private fun test() {
    ...
    """.trimIndent())
    check("mxmxvkd,sqjhc,fvjkl", result)
    ...
    """.trimIndent())
    check("mxkh,gkcqxs,bvh,sp,rgc,krjn,bpbdlmg,tdbcfb", result)
}
