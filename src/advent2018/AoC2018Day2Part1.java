...
public class AoC2018Day2Part1 {
    public static void main(String[] args) {
        ...
        assert result == 6150 : "unexpected result is " + result;
        System.out.println(result);
    }
    ...
    public static int test(String s) {
        ...
        for (String part : parts) {
            ...
            for (int i = 0; i < chars.length; ++i) {
                map.compute(chars[i], (key, v) -> {
                    return v == null ? 1 : v + 1;
                });
            }
            int localSum2 = 0, localSum3 = 0;
            ...
            System.out.print(localSum2 + " " + localSum3);
            if (localSum2 > 1) {
                localSum2 = 1;
            }
            if (localSum3 > 1) {
            ...
            System.out.println(" -> " + localSum2 + " " + localSum3);
            sum2 += localSum2;
            sum3 += localSum3;
        }
        return sum2 * sum3;
