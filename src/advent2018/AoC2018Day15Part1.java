...
public class AoC2018Day15Part1 {
    public static void main(String[] args) {
        ...
        result = test("#######\n" +
                ...
                "#.....#\n" +
                "#######");
        assert result == 27730 : "unexpected result is " + result;
        ...
        result = test("#######\n" +
                ...
                "#...E.#\n" +
                "#######");
        assert result == 36334 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("#######\n" +
                ...
                "#..E#.#\n" +
                "#######");
        assert result == 39514 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("#######\n" +
                ...
                "#...E.#\n" +
                "#######");
        assert result == 27755 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("#######\n" +
                ...
                "#...#G#\n" +
                "#######");
        assert result == 28944 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("#########\n" +
                ...
                "#.....G.#\n" +
                "#########");
        assert result == 18740 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("################################\n" +
                ...
                "######....#.###########...######\n" +
                "################################");
        assert result == 206236 : "unexpected result is " + result;
        System.out.println(result);
        ...
        result = test("################################\n" +
                ...
                "#################.#..###########\n" +
                "################################");
        assert result == 201638 : "unexpected result is " + result;
        System.out.println(result);
    }
    ...
    private static abstract class Unit extends Cell {
        ...
        Unit(Point point, char mnemonic) {
