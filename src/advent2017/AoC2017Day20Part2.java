...
public class AoC2017Day20Part2 {
    ...
    public static void main(String[] args) {
        ...
        result = test("p=<-6,0,0>, v=<3,0,0>, a=<0,0,0>\n" +
    ...
    private static void collide(List<Particle> particles) {
        ...
        for (int i = 0; i < particles.size(); ++i) {
            for (int j = i + 1; j < particles.size(); ++j) {
                if (particles.get(i).collisionOccurred(particles.get(j))) {
                    collided.add(particles.get(i));
                    collided.add(particles.get(j));
                }
            }
        }
    ...
    private static void updateAll(List<Particle> particles) {
    ...
    private static class Particle {
        ...
        boolean collisionOccurred(Particle particle) {
