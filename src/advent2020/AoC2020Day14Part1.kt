...
private fun test(input: String): Long {
    ...
    for (command in commands) {
        ...
        if (matcher.matches()) {
            ...
            if (matcher.matches()) {
                ...
                val valueBin = toBinaryString(value)
                memory[address] = valueBin.applyMask(currentMask!!)
                println("value:\t$valueBin")
                println("mask:\t$currentMask")
                println("result:\t${memory[address]}")
                println()
            } else {
    ...
    return memory.values.map { fromBinaryString(it) }.sum()
}
