...
public class AoC2019Day25 {
    ...
    private static int test(String s) {
        ...
        bfs(new State(commands, getOutput(commands)));
    ...
    private static int bfs(State initialState) {
        ...
        while (opened.size() > 0) {
            ...
            for (State current : opened) {
                ...
                if (output.contains("airlock") || output.contains("password") || output.contains("main")) {
    ...
    private static Set<State> generateNext(State current) {
        ...
        for (int i = tokens.length - 1; i >= 0; --i) {
            ...
            if (token.equals("Doors here lead:")) {
                int j = i + 1;
        ...
        Set<Set<String>> subsets = subsets(items);
        for (String door : doors) {
            ...
            for (Set<String> subset : subsets) {
                ...
                if (newOutput.contains("infinite loop")) {
                    continue;
                }
                set.add(new State(newCommands, newOutput));
            }
        }
    ...
    private static Set<Set<String>> subsets(List<String> set) {
    ...
    private static class State {
        ...
        State(List<String> commands, String output) {
