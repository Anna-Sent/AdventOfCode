...
public class AoC2019Day11Part2 {
    ...
    private static void test(String s) {
        ...
        ProgramState program = new ProgramState("test", new ArrayList<>(values), Collections.singletonList(1L));
        ...
        for (int y = maxy; y >= miny; --y) {
            for (int x = minx; x <= maxx; ++x) {
                int color = mapColors.getOrDefault(new Point(x, y), 0);
