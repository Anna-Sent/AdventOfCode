...
public class AoC2019Day3Part1 {
    ...
    public static void main(String[] args) {
        ...
        assert result == 159 : "unexpected result is " + result;
        System.out.println(result);

        result = test("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51",
                "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7");
        assert result == 135 : "unexpected result is " + result;
        System.out.println(result);
        ...
        assert result == 2193 : "unexpected result is " + result;
        System.out.println(result);
    }
    ...
    private static int test(String p1, String p2) {
        ...
        return closest == null ? -1 : closest.manhattanDistance();
    }

    private static Set<Point> points(String p) {
